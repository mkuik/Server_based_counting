...
/**
 * Created by Matthijs Kuik on 26-12-2015.
 */
public class OnClickRippleView extends View {
    ...
    public OnClickRippleView(Context context) {
        super(context);
        init();
    }

    public OnClickRippleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public OnClickRippleView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        setPointOfCircleOrigin(new Point((int) event.getX(), (int) event.getY()));
